...
def create_parser():
    ...
    # Model type
    parser.add_argument('--model_type', type=str, default='rnn', help='Model type [rnn, gru, attention]')
    ...
    parser.add_argument('--conv_stride', nargs='+', type=int, default=[1,1], help='Convolution stride per layer (sequence of ints)')
    ...
    parser.add_argument('--attention_key_dim', nargs='+', type=int, default=[16], help='Key dimension for attention layers (sequence of ints)')
    parser.add_argument('--attention_pool', nargs='+', type=int, default=[2], help='Attention pooling size (1=None)')

    # Embedding parameters
    parser.add_argument('--embedding_input_dim', type=int, default=10, help='Input Embedding dimension')
